...
export default function Header() {
  return (
    <div
        ...
        style={{ backgroundImage: "url('/assets/blue-background.jpg')" }}
      >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
          ...
          <Link to="/login" className="bg-white text-black px-8 py-4 rounded-full hover:bg-gray-100 transition-colors flex items-center gap-2 text-lg font-medium">
            Get Started
            <Arrow />
          </Link>
        </div>
